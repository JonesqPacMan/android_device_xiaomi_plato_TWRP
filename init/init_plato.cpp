...
void vendor_load_properties()
{
    ...
    for (const string &prop : prop_partitions)
    {
        ...
        property_override(string("ro.product.") + prop + string("name"), "plato");
        property_override(string("ro.product.") + prop + string("device"), "plato");
    ...
    property_override("ro.bootimage.build.date.utc", "1697980701");
    property_override("ro.build.date.utc", "1697980701");
}
